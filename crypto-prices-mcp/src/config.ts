...
const ConfigSchema = z.object({
  ...
  // Legacy names kept for backward compatibility with older .env files.
  HEURIST_FACILITATOR_URL: optionalUrl,
  SEMANTIC_FACILITATOR_URL: optionalUrl,
  CDP_API_KEY_ID: optionalString,
  CDP_API_KEY_SECRET: optionalString,
  PORT: z.coerce.number().default(4021),
  DB_PATH: z.string().default("./crypto-prices.db")
});
