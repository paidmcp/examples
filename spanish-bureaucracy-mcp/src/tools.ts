...
const defaultPromptPath = new URL("./prompts/spanish-autonomo.md", import.meta.url);
...
export const tools: Array<PaidTool<any, any>> = [
  ...
  definePaidTool({
    ...
    description: "Draft a professional Spanish response for a Hacienda situation.",
    priceUsdt: 0.05,
  ...
  definePaidTool({
    ...
    description: "Explain Modelo 130 estimate and likely fields from income and expenses.",
    priceUsdt: 0.05,
    inputSchema: z.object({
