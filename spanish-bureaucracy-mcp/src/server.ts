...
const mcp = new Server({ name: "spanish-bureaucracy-mcp", version: "0.1.0" }, { capabilities: { tools: {} } });
...
app.listen(config.PORT, () => {
  console.log(`spanish-bureaucracy-mcp running on http://localhost:${config.PORT}`);
});
